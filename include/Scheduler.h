...
public:
    ...
    {
        // Dauerhafte, eindeutige Kennung. 0 ist ungueltig.
        ...
        // Bewaesserungsdauer in Sekunden
        uint32_t durationSeconds = 15UL * 60UL;

        // Bit 0 = Montag bis Bit 6 = Sonntag
        uint8_t weekdays = 0;

        // Reine Laufzeitwerte; sie werden nach Neustart zurueckgesetzt.
        bool running = false;
...
private:
    static constexpr uint32_t LEGACY_STORAGE_VERSION = 1;
    static constexpr uint32_t STORAGE_VERSION = 2;

    // Exakte Datenstruktur der bisherigen Speicherversion 1.
